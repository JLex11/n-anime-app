import type { AutocompleteItemChilds, AutocompleteOutputItem } from '@/hooks/useAutocomplete.types'
...
export function CollectionItem({ item }: Props) {
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: this doesn't work as expected
	useEffect(() => {
