...
export function useAutoComplete({
	...
	const [autocompleteState, setAutocompleteState] = useState<AutocompleteState<AutocompleteOutputItem>>()
	...
	const autoComplete = useMemo(
		...
		[autocompleteId, router, getRoutesItems, debouncedGetAnimeItems, handleActiveItem, handleLaunchAutocomplete]
	)
